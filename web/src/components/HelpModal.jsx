...
const PAGES = [
  ...
  },
  {
    ...
    summary: 'ระบบบันทึกและตรวจสอบผลการ Live ขายของ MC แต่ละคน — MC กรอกข้อมูลและแนบหลักฐานหลังจบไลฟ์ · หัวหน้าทีมตรวจหลักฐาน · ผู้บริหารอนุมัติยอดรายเดือน ใช้งานจริงตั้งแต่ 1 ส.ค. 2569',
    tips: [
      { h: 'แท็บ "ภาพรวม" — ดูสถิติและอันดับ', b: 'แสดงการ์ด KPI (ยอดขายรวม จำนวนไลฟ์ ชั่วโมงรวม ค่าโฆษณา) · ตารางจัดอันดับ MC แยกตามบริษัท · กราฟยอดขายรายวัน เลือกช่วงวันที่ได้จากปุ่ม "เลือกช่วงวัน" ด้านบน' },
      { h: 'แท็บ "ภาพรวมรายวัน" — ดูรายวัน', b: 'ตารางสรุปยอดขายและชั่วโมงไลฟ์แยกตามวัน คลิกที่แถววันใดก็ได้เพื่อดูรายละเอียดว่า MC คนไหนไลฟ์บ้างในวันนั้น' },
      { h: 'แท็บ "กรอกของฉัน" — สำหรับ MC', b: 'MC กรอกข้อมูลแต่ละ Session หลังจบไลฟ์ ได้แก่ บริษัท ชื่อ MC วันที่ เวลาเริ่ม-จบ ช่องทาง ประเภทกล้อง ยอดขาย (GMV จาก Seller Center) ค่าโฆษณา หมายเหตุ และแนบภาพหลักฐาน → กด "บันทึกของฉัน" เมื่อครบ หัวหน้าจะเห็นทันที' },
      { h: 'แนบหลักฐานให้ครบ (สำคัญมาก)', b: 'มือถือ: ต้องแนบ 3 รูป — ภาพหน้าจอไลฟ์, หน้ายอดขาย, หน้าจบไลฟ์ | OBS: แนบ 1 รูป — ภาพ screenshot จากโปรแกรม OBS เท่านั้น ยอดขายให้ดูจาก Dashboard Seller Center ณ เวลาปิดไลฟ์' },
      { h: 'แท็บ "ตรวจหลักฐาน" — สำหรับหัวหน้าทีม', b: 'หัวหน้าทีมเปิดตารางรายการของ MC ทุกคน · คลิกแถวเพื่อดูรูปหลักฐาน · กด "อนุมัติ" หรือ "ส่งกลับแก้ไข" · รายการที่ถูกล็อก (สีเขียว) คือผ่านการอนุมัติรายเดือนแล้ว แก้ไขไม่ได้' },
      { h: 'แท็บ "อนุมัติรายเดือน" — สำหรับ ADMIN', b: 'เมื่อ MC ทุกคนกรอกครบและหัวหน้าเช็คแล้ว ADMIN กด "อนุมัติเดือนนี้" เพื่อล็อกยอดเป็นข้อมูลจริง · ถ้าต้องแก้ไขหลังอนุมัติ กด "เปิดเดือนกลับมาแก้ไข" ก่อน · เงื่อนไข: ทุกรายการต้องสถานะ DONE + หลักฐาน COMPLETE' },
      { h: 'แท็บ "แก้ไขตาราง" — สำหรับ ADMIN', b: 'ADMIN แก้ไขข้อมูลทุกรายการโดยตรงในตาราง · กดปุ่ม "แก้ไข" ที่แถว → แก้ข้อมูล → กด "บันทึก" · รายการที่ถูกล็อก (อนุมัติแล้ว) จะมีไอคอน 🔒 และแก้ไขไม่ได้' },
      { h: 'สถานะรายการ', b: 'PLANNED = แผนไลฟ์ที่ยังไม่ได้ทำ · LIVE = กำลังไลฟ์อยู่ · DONE = จบไลฟ์แล้ว รอตรวจ · APPROVED = หัวหน้าเช็คผ่านแล้ว · CANCELLED = ยกเลิก | รายการที่ถูก "อนุมัติรายเดือน" จะล็อกทุกสถานะ' },
      { h: 'การลบรายการ', b: 'กด "ลบ" ที่แถวที่ต้องการ — ลบได้เฉพาะรายการที่ยังไม่ถูกอนุมัติ (ไม่มีไอคอน 🔒) · MC ลบได้เฉพาะรายการของตัวเอง · หัวหน้าและ ADMIN ลบได้ทุกรายการที่ไม่ล็อก' },
    ]
  },
  {
    key: 'upload',
