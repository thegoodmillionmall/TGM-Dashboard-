          ...
          <tbody>{visibleRows.map(({ row: r, index: i }) => {
            ...
            return (
              <tr key={r.id || i}>
                ...
                <td><input type="number" step="0.01" value={(Number(r.actualSales)||0).toFixed(2)} onChange={e => update(i, 'actualSales', e.target.value)} style={{ width: 100, textAlign: 'right' }} disabled={locked} /></td>
                ...
                <td><input type="number" step="0.01" value={(Number(r.adsCost)||0).toFixed(2)} onChange={e => update(i, 'adsCost', e.target.value)} style={{ width: 90, textAlign: 'right' }} disabled={locked} /></td>
